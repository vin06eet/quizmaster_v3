      ...
      <div className="relative w-full max-w-md px-4">
        <Card className="bg-black/30 backdrop-blur-md border border-white/10 shadow-2xl rounded-3xl overflow-hidden">
          ...
          <div className="p-8">
            ...
            <h1 className="text-3xl font-bold text-white text-center mb-1">Welcome</h1>
            <p className="text-gray-400 text-center mb-8">Create an account to enjoy all features</p>
            
            <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
                <label className="text-sm font-extrabold text-gray-300 pl-1">Username</label>
